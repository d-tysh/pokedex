...
export const PokemonInfo = ({selectedPokemon}) => {
    ...
    return (
        <>
            ...
            {!loading && <div className="p-2 border border-black w-[25%] inline-block sticky top-8">
                <div className="border">
                    <img src={pokemonInfo?.sprites?.other?.['dream_world']?.['front_default']} alt="Pokemon info img" className="mx-auto" />
                </div>
